...
public class Variables {
	...
	// Fork Limitation
	public static ValueReference<Double> forkBackwardLimit = new ValueReference<Double>(400.0);
	public static ValueReference<Double> forkForwardLimit = new ValueReference<Double>(700.0);
